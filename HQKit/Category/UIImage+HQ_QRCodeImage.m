...
#import "UIImage+HQ_QRCodeImage.h"
#import <CoreImage/CoreImage.h>

@implementation UIImage (HQ_QRCodeImage)
...
- (UIImage *)createQRCodeWithUrl:(NSString *)url {
    ...
    // 添加logo
    qrcode = [self drawImage:[UIImage imageNamed:@"qr_logo"] inImage:qrcode];
    return qrcode;
}
